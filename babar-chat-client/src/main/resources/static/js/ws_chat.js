...
function queryMsg(event) {
    ...
    var modal = $("#chatModal");
    modal.find('.modal-title').text('Send to: ' + recipient_name);
...
function handleQueryMsgResp(resp) {
    ...
    if (jsonarray != "") {
        ...
        $.each(jsonarray, function (i, msg) {
            ...
            if ((relation_type == 0) && (owner_uid == sender_id)) {
            ...
            } else if ((relation_type == 1) && (owner_uid == sender_id)) {
...
function handleSendMsgResp(resp) {
    ...
    if (flag1 == false) {
        ...
        var td_button = "<td><button type='button' class='btn btn-info' data-toggle='modal' data-target='#chatModal' data-recipient_id='" + jsonContent.otherUid + "' data-recipient_name='" + jsonContent.otherName + "'>Chat</button></td>";
...
function handleReceivedMsg(pushedMsg) {
    ...
    if (flag2 == false) {
        ...
        var td_button = "<td><button type='button' class='btn btn-info' data-toggle='modal' data-target='#chatModal' data-recipient_id='" + jsonRecipient.ownerUid + "' data-recipient_name='" + jsonRecipient.ownerName + "'>Chat</button></td>";
